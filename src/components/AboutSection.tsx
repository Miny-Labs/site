  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          Building{' '}
          <span className="font-serif-italic text-white/60">experiments</span>{' '}
          at the <br className="hidden md:block" />
          <span className="font-serif-italic text-white/60">edge</span> of
          crypto and{' '}
